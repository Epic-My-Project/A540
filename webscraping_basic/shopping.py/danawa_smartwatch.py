...
url = "https://prod.danawa.com/list/?cate=12215657"
...
tv = soup.find_all("li", attrs={ "class" : "prod_item prod_layer" })

with open("danawa_smartwatch.txt", "w", encoding="utf-8", newline="") as lap:
   for target in tv:
